...
export const authenticate = async (
  ...
  try {
    ...
    if (!token) {
      const response = ApiResponse.unauthorized('NO_TOKEN', 'Authentication token is required', {
    ...
    const response = ApiResponse.internalError(error instanceof Error ? error : undefined);
